...
describe('Login Component', () => {
    ...
    it('shows an error message on failed login', async () => {
        ...
        await waitFor(() => {
            expect(screen.getByText((content, element) => content.includes('Invalid credentials'))).toBeInTheDocument();
        });

        // Check if error message is displayed
        expect(screen.getByText(/Invalid credentials/i, { exact: false })).toBeInTheDocument();
    });
