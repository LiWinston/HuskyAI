...
public class RemoteServiceConfig {
    ...
    /**
     * Model access configuration from the server's perspective; models not configured
     * here will not be registered or accessible.
     */
    @Data
    public static class ServiceConfig {
        ...
        /**
         * Model access restrictions from the server's perspective, globally effective,
         * e.g., { "allowedModels": ["model1", "model2"] }.
         */
